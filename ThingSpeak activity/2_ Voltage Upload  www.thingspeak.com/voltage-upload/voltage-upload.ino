...
byte mac[] = { 0x00, 0xAA, 0xBB, 0xCC, 0xDE, 0x32 }; // Must be unique on local network

// ThingSpeak Settings
char thingSpeakAddress[] = "api.thingspeak.com";
String writeAPIKey = "9DHQ6EY6IRHAD8P1";
...
void loop()
{
  ...
  String analogValue0 = String(analogRead(A0)*(4.76/1024), DEC);
